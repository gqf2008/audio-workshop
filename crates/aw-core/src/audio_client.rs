...
fn build_synth_request(text: &str, seed: Option<u64>, voice_ref: Option<&str>) -> Value {
...
impl Client {
    ...
    pub fn synth(
        ...
        self.run_audio(model, build_synth_request(text, seed, voice_ref))
    }
...
mod tests {
    ...
    fn synth_request_body_only_carries_whitelisted_options() {
        ...
        let with_ref = build_synth_request("你好。", None, Some("/tmp/ref.wav"));
